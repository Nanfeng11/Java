                ...
                if(resultSet != null){
                    try{
                        while(resultSet.next()){////如果返回true表示有下一行记录，则否无记录
                            ...
                            LocalDateTime createdTime = resultSet.getTimestamp
                                    ("created_time").toLocalDateTime();
                            LocalDateTime modifyTime = resultSet.getTimestamp
                                    ("modify_time").toLocalDateTime();
                            System.out.println(
                                    String.format(
